...
%
To address this problem, I developed a new inherently explainable machine learning method by designing a domain-specific language, called \GDL, and synthesis algorithms that learn models from training graph data.
%
