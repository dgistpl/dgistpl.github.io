...
%
In my future work, I will address the existing challenges and limitations in the current methods. I will also expand the use of the DSL-based approach to other domains.


\subsection{Improving the DSL-based Approaches}
...
%
SBFL, however, has a severe limitation in accuracy; it often fails to identify the locations of faults.
%
To address this problem, I am developing a DSL-based approach to improve the accuracy of SBFL.
...
\myparagraph{Generalization to Explainable Graph Machine Learning}
...
%
To address this problem, I developed a new inherently explainable machine learning method by designing a domain-specific language, called \GDL, and synthesis algorithms that learn models from training data.
%
The experimental results show that our DSL-based approach successfully generates inherently explainable graph machine learning models that have comparable accuracy to the existing neural network-based models but provide significantly better explanations for the predictions.
%
Recently, I submitted a paper with the preliminary results.
%
