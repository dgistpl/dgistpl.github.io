...
\begin{frame}{Step 2: Open in VS Code}
  ...
  \begin{center}
    \begin{tikzpicture}[
      panel/.style={draw=gray!50, fill=gray!5, rounded corners=4pt, minimum height=3cm, align=center}
    ]
      \node[panel, minimum width=4.5cm] (editor) at (0,0) {\small\textbf{File Explorer}\\\small\textcolor{gray}{lec1.pdf, lec2.pdf,}\\\small\textcolor{gray}{lec3.pdf, ...}};
      \node[panel, minimum width=4.5cm, fill=MutedBlue] (chat) at (6,0) {\small\textbf{Claude Code Panel}\\\small\textcolor{gray}{Ask questions here}};
      \node[above=0.2cm of editor, font=\footnotesize\bfseries, text=gray] {Left};
      \node[above=0.2cm of chat, font=\footnotesize\bfseries, text=themeblue] {Right};
    \end{tikzpicture}
  \end{center}
\end{frame}
...
\begin{frame}{Summary}
  ...
  \vspace{1.5em}
  \begin{itemize}
    \item Install: VS Code + Node.js + Claude Code + Extension
