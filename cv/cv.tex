...
\begin{center}
    ...
    % \href{https://dgistpl.github.io/}{\raisebox{-0.2\height}\faHome\ \underline{https://dgistpl.github.io/}} 
    \vspace{-8pt}
\end{center}
...
(KDD 2026, OOPSLA 2025, PLDI 2024, POPL 2022, OOPSLA 2020, OOPSLA 2018, and OOPSLA 2017) and
journal (TOPLAS 2019).
\begin{enumerate}
  \item {
    \underline{Minseok Jeon}, Seunghyun Park, and Jun-Gi Jang.\\
    \textit{ProgNet: Program-Grounded Evidence Composition for Interpretable Graph Classification.}\\
    KDD 2026: The 32nd ACM SIGKDD Conference on Knowledge Discovery and Data Mining. August 2026
  }
  \item {
...
\begin{enumerate}
  \item{NSAD 2026: ACM SIGPLAN International Workshop on Numerical and Symbolic Abstract Domains}
...
Journal Reviewer:
\begin{enumerate}
\item{TOSEM: ACM Transactions on Software Engineering and Methodology (2025, 2026)}
\end{enumerate}
...
\begin{enumerate}
  \item{AI를 활용한 수업자료 자동 생성 프레임워크. AI 활용 경진대회, DGIST. Nov. 4 2025.}

  \item{Developing Cost-Effective Combinations of Static Analysis Techniques. Dagstuhl Seminar 25421 (Sound Static Program Analysis in Modern Software Engineering), Dagstuhl, Germany. Oct. 16 2025.}
