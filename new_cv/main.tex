...
I am interested in designing domain-specific programming languages (DSLs) 
and developing program synthesis algorithms to address problems in programming languages and software engineering.
%
...
journal (TOPLAS 2019). 
%
Notably, POPL is the most prestigious conference in programming languages (less than ten papers from Korea have been accepted at POPL). 
\begin{enumerate}
  % \item {
