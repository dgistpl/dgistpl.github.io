...
addressing challenges in programming languages and software engineering.\vspace{-4pt}
...
\begin{itemize}
  ...
  \item \textbf{Program Synthesis} aimed at automatically generating solutions (programs) in DSLs.\vspace{-4pt}
...
journal (TOPLAS 2019). 
In particular, POPL is the most prestigious conference in programming languages (less than ten papers from Korea have been accepted at POPL). 
\begin{enumerate}
  % \item {
