...
\begin{enumerate}
  \item {
    ...
    \textit{Marriage of Context Tunneling and Selective Context Sensitivity in Pointer Analysis  (Submitted).}\\ March 2025
  }
  \item {
    Donguk Kim, \underline{Minseok Jeon*}, Doha Hwang, Hakjoo Oh* (*corresponding authors).\\
    \textit{PAFL: Enhancing Fault Localizers by Leveraging Project-Specific Fault Patterns (to appear).}\\
...
\begin{itemize}
  \item{{\bf 2024 Fall (Lecturer):} Data Structure (Korea University COSE214)}
\end{itemize}
