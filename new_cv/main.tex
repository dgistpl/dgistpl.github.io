...
addressing challenges in programming language and software engineering.

\begin{itemize}
  \item \textbf{Domain-specific language (DSL) design} to tackle challenges in programming languages and software engineering. \vspace{-4pt}
  \item \textbf{Program Synthesis} aimed at automatically generating solutions (programs) in DSLs.
\end{itemize}

I am interested in designing DSLs and synthesis algorithms for developing effective pointer analysis, which is a key ingredient in compiler optimization and various software engineering techniques. 
I also interested in developing DSLs for software testing, specifically to find effective test cases for system software testing
...
journal (TOPLAS 2019). \emph{POPL paper}
\begin{enumerate}
  % \item {
